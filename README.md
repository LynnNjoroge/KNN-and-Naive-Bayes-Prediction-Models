...
This project seeks to create predictive models that can effectively Predict the survivals and deaths of the Titanic disaster using K-nearest neighbours classifier and Predict the chance of an email being spam or a not-spam using Naive Bayes theorem.
